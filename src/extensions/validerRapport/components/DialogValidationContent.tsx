...
import { IDialogValidationContentProps } from './IDialogValidationContentProps';
...
export default class DialogValidationContent extends React.Component<IDialogValidationContentProps, {Lat:number, Lng:number, SurfPond:number, SurfTerr:number, SurfConstr:number, PrixEval:number, alertVide:boolean, alertValidation:boolean, alertUpdate:boolean}> {
